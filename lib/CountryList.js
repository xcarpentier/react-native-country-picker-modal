...
const Letter = ({ letter, scrollTo }) => {
    ...
    return (React.createElement(TouchableOpacity, Object.assign({ testID: `letter-${letter}`, key: letter, onPress: () => scrollTo(letter) }, { activeOpacity }),
        React.createElement(View, { style: styles.letter },
            React.createElement(CountryText, { style: [styles.letterText, { fontSize: alphaFontSize }], allowFontScaling: false }, letter))));
};
    ...
    return (React.createElement(TouchableOpacity, Object.assign({ key: country.cca2, testID: `country-selector-${country.cca2}`, onPress: () => onSelect(country) }, { activeOpacity }),
        React.createElement(View, { style: [styles.itemCountry, { height: itemHeight }] },
            ...
            React.createElement(View, { style: styles.itemCountryName },
                React.createElement(CountryText, { allowFontScaling: false, numberOfLines: 2, ellipsizeMode: 'tail', style: { textAlign: isRTL ? 'right' : 'left' } },
                    country.name,
...
export const CountryList = (props) => {
    ...
    return (React.createElement(View, { style: [
        ...
        withAlphaFilter && (React.createElement(ScrollView, { contentContainerStyle: [
                styles.letters,
                isRTL ? styles.lettersRTL : styles.lettersLTR,
            ], keyboardShouldPersistTaps: 'always' }, letters.map(letter => (React.createElement(Letter, Object.assign({ key: letter }, { letter, scrollTo }))))))));
};
