...
export const Flag = ({ countryCode, withEmoji, withFlagButton, flagSize, isRTL, }) => withFlagButton ? (React.createElement(View, { style: [
        styles.container,
        isRTL ? styles.containerRTL : styles.containerLTR,
    ] }, withEmoji ? (React.createElement(EmojiFlag, Object.assign({}, { countryCode, flagSize }))) : (React.createElement(ImageFlag, Object.assign({}, { countryCode, flagSize }))))) : null;
Flag.defaultProps = {
    withEmoji: true,
    withFlagButton: true,
};
